...
if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'update_form') {
   ...
   if (isset($_SERVER['HTTP_REFERER'])) 
   {
		...
		$sql="SELECT * FROM specialties WHERE 1 AND specialties.id=$specialist_id";  
...
<form method="POST" action="specialties_functions.php" enctype="multipart/form-data">

    <table dir="rtl" width="70%" class="tablein">

        
        <tr>
            <td width=25%>اسم التخصص</td>
        ...
        <tr>
		    ...
		    ?>
		    	...
		    	<input type='hidden' name='specialist_id' value='<?php echo $specialist_id;?>' />
