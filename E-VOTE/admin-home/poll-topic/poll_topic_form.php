...
if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'update_form') {
   ...
   if (isset($_SERVER['HTTP_REFERER'])) 
   {
		...
		$sql="SELECT * FROM poll_topic WHERE 1 AND poll_topic.id=$poll_topic_id";  
...
<form method="POST" action="poll_topic_functions.php" enctype="multipart/form-data">

    <table dir="rtl" width="50%" class="tablein">

        
        <tr>
            <td width=25%>موضوع الاستفتاء</td>
