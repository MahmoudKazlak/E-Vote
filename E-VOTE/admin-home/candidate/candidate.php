...
<div class="title">سجل المرشحين</div>


<br>
<center>
<a class="btn btn-warning" href="candidate_form.php?action=add_row&residence_region_id=<?php echo $residence_region_id;?>&specialty_id=<?php echo $specialty_id;?>" >
		<span style="float:right;margin-right:10px;" >اضافة مرشح</span>
</a>
...
<table class="table" width="100%" >
    ...
    <?php
		...
		FROM candidate 
		LEFT JOIN specialties ON candidate.specialty_id=specialties.id 
		LEFT JOIN residence_region ON candidate.residence_region_id=residence_region.id   
		WHERE 1  
		AND candidate.is_canceled=0 
    ...
    while ($row = mysqli_fetch_array($query)) {
        ...
        <tr>
            ...
            <td><a class="iconEdit" title="تعديل  " href="candidate_form.php?action=edit_row&row_id=<?php echo $id; ?>"> </a></td>
